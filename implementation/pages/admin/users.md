...
*   [ ] **Notes**: Admin-only private notes field for each user.
*   [ ] **Last IP**: Show the last known IP address in the user table.
*   [ ] **Verification Status**: Toggle email verification manually.
*   [ ] **Shadow Ban**: Allow user to use site but run no actual campaigns.
*   [ ] **Password Reset Link**: Generate a manual reset link to copy-paste.
*   [ ] **Referral Tree**: Visualize who referred this user.
*   [ ] **Export Users**: Download user list as CSV/JSON.
*   [ ] **Import Users**: Bulk create users from CSV.
*   [ ] **User Segments**: Create saved filters (e.g., "Whales", "Newbies").
*   [ ] **Tagging**: Add multiple tags to users (e.g., "High Risk", "VIP").
*   [ ] **Risk Score**: Display fraud score from 3rd party tool.
*   [ ] **Session Manager**: View and kill specific active user sessions.
*   [ ] **Plan Override**: Manually set user to "Pro" plan for free.
*   [ ] **Discount Override**: Set permanent distinct discount for user.
*   [ ] **Credit History**: View log of every credit change (admin or system).
*   [ ] **Login As**: "Magic Link" to login as user without password.
...
*   [ ] **Geo Location**: Show city/country of last login.
...
*   [ ] **Project Count**: Column showing number of active projects.
*   [ ] **Total Spend**: Column showing lifetime revenue from user.
*   [ ] **Last Active**: Sort by last login date.
*   [ ] **Signup Source**: Show UTM source of registration.
*   [ ] **Referrer**: Show who referred this user.
*   [ ] **Ban Reason**: Text field to explain why user was banned.
