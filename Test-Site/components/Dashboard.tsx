        ...
        <footer className="px-12 py-8 border-t border-gray-200 mt-auto bg-white">
            <div className="max-w-screen-2xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
                <div className="flex flex-wrap justify-center gap-8 text-[10px] font-bold uppercase tracking-widest text-gray-400">
                    <button onClick={() => onNavigate('helpdesk')} className="hover:text-[#ff4d00] transition-colors">Helpdesk</button>
                    <button onClick={() => onNavigate('refund')} className="hover:text-[#ff4d00] transition-colors">Refund Policy</button>
                    <button onClick={() => onNavigate('delivery')} className="hover:text-[#ff4d00] transition-colors">Delivery Policy</button>
                    <button onClick={() => onNavigate('privacy')} className="hover:text-[#ff4d00] transition-colors">Privacy Policy</button>
                    <button onClick={() => onNavigate('terms')} className="hover:text-[#ff4d00] transition-colors">Terms of Service</button>
                    <button onClick={() => onNavigate('agb')} className="hover:text-[#ff4d00] transition-colors">AGB</button>
                    <button onClick={() => onNavigate('impressum')} className="hover:text-[#ff4d00] transition-colors">Impressum</button>
                </div>
