...
const AdminProjects: React.FC<AdminProjectsProps> = ({ projects, onEditProject, onCreateProject }) => {

    return (
        <div className="animate-in fade-in">
            <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-black uppercase tracking-tight">Global Projects</h2>
                <button
                    onClick={onCreateProject}
                    className="bg-black hover:bg-gray-800 text-white px-4 py-2 rounded text-xs font-bold uppercase tracking-wider transition-colors"
                >
                    + New Project
                </button>
            </div>
