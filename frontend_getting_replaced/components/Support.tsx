...
const Support: React.FC = () => {
    ...
    const activeProject = activeTicket?.projectId ? projects.find(p => p.id === activeTicket.projectId) : null;
                        ...
                        <form onSubmit={handleCreateTicket} className="p-8 space-y-6">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full bg-[#f9fafb] border border-gray-200 p-3 text-sm font-bold text-gray-900 focus:border-[#ff4d00] outline-none"
                                >
                                    <option value="">General Inquiry / No Project</option>
                                    {projects.map(p => (
                                ...
                                <div className="text-xs text-gray-400 font-mono mt-1 flex items-center gap-2">
                                    ...
                                    {activeProject && (
                                        <>
                                            ...
                                            <span className="text-[#ff4d00] font-bold uppercase tracking-wider">Project: {activeProject.name}</span>
                                        </>
                                    )}
                                </div>
                            </div>
