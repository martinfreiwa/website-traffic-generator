...
const HelpDesk: React.FC<HelpDeskProps> = ({ onBack }) => {
    ...
    return (
        <div className="min-h-screen bg-white text-gray-900 font-sans">
            <Helmet>
                <title>Help Center - Traffic Creator | Support & Tutorials</title>
                <meta name="description" content="Find answers to your questions about Traffic Creator, campaign setup, billing, and technical support." />
                <meta name="keywords" content="traffic generator support, campaign help, billing support, technical support SEO, GA4 traffic troubleshooting, AdSense safe traffic help" />

                {/* OpenGraph */}
                <meta property="og:title" content="Help Center - Traffic Creator | Support & Tutorials" />
                <meta property="og:description" content="Find answers and tutorials for the Traffic Creator platform." />
                <meta property="og:type" content="website" />
                <meta property="og:url" content="http://localhost:3000/helpdesk" />

                {/* Twitter */}
                <meta name="twitter:card" content="summary" />
                <meta name="twitter:title" content="Help Center - Traffic Creator" />
                <meta name="twitter:description" content="Support and tutorials for our traffic generation platform." />
            ...
            <div className="bg-[#111] text-white pt-20 pb-32 px-6 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto relative z-10">
                    <Link to="/" className="flex items-center gap-2 text-gray-400 hover:text-white mb-8 text-xs font-bold uppercase tracking-wider transition-colors">
