    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans overflow-hidden">
          ...
          <div className="text-center mb-16">
            ...
            <div className="inline-flex bg-white border border-gray-200 p-1 rounded-sm shadow-sm">
              <button
                ...
                className={`px-6 py-3 text-xs font-bold uppercase tracking-wider rounded-sm transition-all ${pricingMode === 'business' ? 'bg-black text-white shadow-lg' : 'text-gray-500 hover:text-black'
                  }`}
              >
                Business Growth
              </button>
              <button
                ...
                className={`px-6 py-3 text-xs font-bold uppercase tracking-wider rounded-sm transition-all ${pricingMode === 'agency' ? 'bg-[#ff4d00] text-white shadow-lg' : 'text-gray-500 hover:text-[#ff4d00]'
                  }`}
              >
                Agency & Reseller
              </button>
      ...
      <footer className="bg-black text-white py-16 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="text-2xl font-black text-white tracking-tight">TRAFFIC BOT</div>
          <div className="flex flex-col md:flex-row gap-8 text-xs font-bold uppercase tracking-widest text-gray-500 text-center md:text-left">
            ...
            <button onClick={() => onNavigate('terms')} className="hover:text-white uppercase">Terms of Use</button>
          </div>
